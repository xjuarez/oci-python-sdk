...
from .named_capture_value import NamedCaptureValue
...
from .parser_test_result_field_value import ParserTestResultFieldValue
...
log_analytics_type_mapping = {
    ...
    "NamedCaptureValue": NamedCaptureValue,
    "Namespace": Namespace,
    ...
    "ParserTestResultFieldValue": ParserTestResultFieldValue,
