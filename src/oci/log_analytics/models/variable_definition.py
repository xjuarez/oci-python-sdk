...
class VariableDefinition(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param map_keys:
            The value to assign to the map_keys property of this VariableDefinition.
        :type map_keys: list[oci.log_analytics.models.VariableDefinition]
        ...
        self.swagger_types = {
            ...
            'description': 'str',
            'type': 'str',
            'map_keys': 'list[VariableDefinition]',
            'default_value': 'str',
    ...
    def map_keys(self):
        """
        Gets the map_keys of this VariableDefinition.
        List of variables if this variable is a map.


        :return: The map_keys of this VariableDefinition.
        :rtype: list[oci.log_analytics.models.VariableDefinition]
        """
        return self._map_keys

    @map_keys.setter
    def map_keys(self, map_keys):
        """
        Sets the map_keys of this VariableDefinition.
        List of variables if this variable is a map.


        :param map_keys: The map_keys of this VariableDefinition.
