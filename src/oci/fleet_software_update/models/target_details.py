...
class TargetDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.fleet_software_update.models.ExadbVmClusterTargetSummary`
        ...
        * :class:`~oci.fleet_software_update.models.DatabaseTargetSummary`
        ...
        :param entity_type:
            ...
            Allowed values for this property are: "DATABASE", "VMCLUSTER", "CLOUDVMCLUSTER", "EXADBVMCLUSTER", 'UNKNOWN_ENUM_VALUE'.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'EXADBVMCLUSTER':
            return 'ExadbVmClusterTargetSummary'
