...
class DbBackupsClient(object):
    ...
    def export_backup(self, backup_id, export_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/mysql/export_backup.py.html>`__ to see an example of how to use export_backup API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['backupId']
