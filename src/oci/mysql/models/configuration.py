...
class Configuration(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param options:
            The value to assign to the options property of this Configuration.
        :type options: list[oci.mysql.models.Option]
    ...
    def options(self, options):
        """
        Sets the options of this Configuration.
        The MySQL options defined in the Configuration.


        :param options: The options of this Configuration.
        :type: list[oci.mysql.models.Option]
        """
