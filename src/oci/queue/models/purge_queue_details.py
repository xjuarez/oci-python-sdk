...
class PurgeQueueDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param consumer_group_id:
            The value to assign to the consumer_group_id property of this PurgeQueueDetails.
    ...
    def consumer_group_id(self):
        """
        Gets the consumer_group_id of this PurgeQueueDetails.
        ...
        :return: The consumer_group_id of this PurgeQueueDetails.
        :rtype: str
        """
    ...
    def consumer_group_id(self, consumer_group_id):
        """
        Sets the consumer_group_id of this PurgeQueueDetails.
        The consumer group ID to purge. If the CONSUMER_GROUPS capability is enabled on the queue, omitting that field
        will purge the \"Primary Consumer Group\", otherwise it will purge the queue.
        If you wish to purge all consumer groups in the queue, you can pass the special value 'all'.


        :param consumer_group_id: The consumer_group_id of this PurgeQueueDetails.
        :type: str
        """
