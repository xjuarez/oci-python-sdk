...
class QueueStats(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param consumer_group_id:
            The value to assign to the consumer_group_id property of this QueueStats.
    ...
    def consumer_group_id(self, consumer_group_id):
        """
        Sets the consumer_group_id of this QueueStats.
        If consumerGroupId is present in GetStats call, the consumer group id will be returned in the GetStats response.


        :param consumer_group_id: The consumer_group_id of this QueueStats.
        :type: str
        """
