...
class QueueAdminClient(object):
    ...
    def create_consumer_group(self, create_consumer_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/queue/create_consumer_group.py.html>`__ to see an example of how to use create_consumer_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_consumer_group(self, consumer_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/queue/delete_consumer_group.py.html>`__ to see an example of how to use delete_consumer_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_consumer_group(self, consumer_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/queue/get_consumer_group.py.html>`__ to see an example of how to use get_consumer_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['consumerGroupId']
        resource_path = "/consumerGroups/{consumerGroupId}"
    ...
    def list_consumer_groups(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/queue/list_consumer_groups.py.html>`__ to see an example of how to use list_consumer_groups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/consumerGroups"
    ...
    def update_consumer_group(self, consumer_group_id, update_consumer_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/latest/queue/update_consumer_group.py.html>`__ to see an example of how to use update_consumer_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['consumerGroupId']
        resource_path = "/consumerGroups/{consumerGroupId}"
