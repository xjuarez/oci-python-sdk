...
class UpdateCertificateAuthorityConfigDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.certificates_management.models.UpdateRootCaManagedExternallyConfigDetails`
        ...
        * :class:`~oci.certificates_management.models.UpdateSubordinateCaManagedInternallyIssuedByExternalCaConfigDetails`
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'ROOT_CA_MANAGED_EXTERNALLY':
            return 'UpdateRootCaManagedExternallyConfigDetails'
        ...
        if type == 'SUBORDINATE_CA_MANAGED_INTERNALLY_ISSUED_BY_EXTERNAL_CA':
            return 'UpdateSubordinateCaManagedInternallyIssuedByExternalCaConfigDetails'
        else:
