...
class CertificateAuthorityRule(object):
    ...
    #: A constant which can be used with the rule_type property of a CertificateAuthorityRule.
    #: This constant has a value of "CERTIFICATE_AUTHORITY_ISSUANCE_RULE"
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.certificates_management.models.CertificateAuthorityIssuanceRule`

        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param rule_type:
            The value to assign to the rule_type property of this CertificateAuthorityRule.
            Allowed values for this property are: "CERTIFICATE_AUTHORITY_ISSUANCE_EXPIRY_RULE", "CERTIFICATE_AUTHORITY_ISSUANCE_RULE", 'UNKNOWN_ENUM_VALUE'.
    ...
    def get_subtype(object_dictionary):
        ...
        if type == 'CERTIFICATE_AUTHORITY_ISSUANCE_RULE':
            return 'CertificateAuthorityIssuanceRule'
        else:
    ...
    def rule_type(self, rule_type):
        ...
        :type: str
        """
        allowed_values = ["CERTIFICATE_AUTHORITY_ISSUANCE_EXPIRY_RULE", "CERTIFICATE_AUTHORITY_ISSUANCE_RULE"]
