...
class UpdateServiceDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.network_firewall.models.UpdateUdpServiceDetails`
        ...
        :param description:
            The value to assign to the description property of this UpdateServiceDetails.
    ...
    def description(self):
        """
        Gets the description of this UpdateServiceDetails.
        The description of the service. This field can be used to add additional info.


        :return: The description of this UpdateServiceDetails.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this UpdateServiceDetails.
        The description of the service. This field can be used to add additional info.


        :param description: The description of this UpdateServiceDetails.
        :type: str
        """
