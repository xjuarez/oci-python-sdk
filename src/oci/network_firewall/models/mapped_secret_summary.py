...
class MappedSecretSummary(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param description:
            The value to assign to the description property of this MappedSecretSummary.
    ...
    def description(self):
        """
        Gets the description of this MappedSecretSummary.
        The description of the mapped secret. This field can be used to add additional info.


        :return: The description of this MappedSecretSummary.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this MappedSecretSummary.
        The description of the mapped secret. This field can be used to add additional info.


        :param description: The description of this MappedSecretSummary.
        :type: str
        """
