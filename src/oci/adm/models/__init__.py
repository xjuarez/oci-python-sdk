...
from .related_vulnerability_reference import RelatedVulnerabilityReference
...
from .vulnerability_details_collection import VulnerabilityDetailsCollection
from .vulnerability_metric import VulnerabilityMetric
from .vulnerable_artifact_version_range import VulnerableArtifactVersionRange
...
adm_type_mapping = {
    ...
    "RelatedVulnerabilityReference": RelatedVulnerabilityReference,
    ...
    "VulnerabilityDetailsCollection": VulnerabilityDetailsCollection,
    "VulnerabilityMetric": VulnerabilityMetric,
    "VulnerableArtifactVersionRange": VulnerableArtifactVersionRange,
