...
from .cloud_exadata_infrastructure_collection import CloudExadataInfrastructureCollection
from .cloud_exadata_infrastructure_discovery import CloudExadataInfrastructureDiscovery
from .cloud_exadata_infrastructure_summary import CloudExadataInfrastructureSummary
from .cloud_exadata_storage_connector import CloudExadataStorageConnector
from .cloud_exadata_storage_connector_collection import CloudExadataStorageConnectorCollection
from .cloud_exadata_storage_connector_status import CloudExadataStorageConnectorStatus
from .cloud_exadata_storage_connector_summary import CloudExadataStorageConnectorSummary
from .cloud_exadata_storage_grid import CloudExadataStorageGrid
from .cloud_exadata_storage_grid_summary import CloudExadataStorageGridSummary
from .cloud_exadata_storage_server import CloudExadataStorageServer
from .cloud_exadata_storage_server_collection import CloudExadataStorageServerCollection
from .cloud_exadata_storage_server_summary import CloudExadataStorageServerSummary
from .cloud_iorm_plan import CloudIormPlan
...
from .cloud_open_alert_history import CloudOpenAlertHistory
...
from .create_cloud_exadata_storage_connector_details import CreateCloudExadataStorageConnectorDetails
...
from .discover_cloud_exadata_infrastructure_details import DiscoverCloudExadataInfrastructureDetails
...
from .enable_cloud_exadata_infrastructure_management_details import EnableCloudExadataInfrastructureManagementDetails
...
from .exadata_fleet_metric_definition import ExadataFleetMetricDefinition
from .exadata_fleet_metric_summary_definition import ExadataFleetMetricSummaryDefinition
from .exadata_infrastructure_discovery_summary import ExadataInfrastructureDiscoverySummary
from .exadata_infrastructure_fleet_health_metrics import ExadataInfrastructureFleetHealthMetrics
from .exadata_infrastructure_fleet_status_by_category import ExadataInfrastructureFleetStatusByCategory
from .exadata_infrastructure_fleet_summary import ExadataInfrastructureFleetSummary
from .exadata_infrastructure_lifecycle_state_values import ExadataInfrastructureLifecycleStateValues
from .exadata_infrastructure_usage_metrics import ExadataInfrastructureUsageMetrics
from .exadata_metric_dimension_definition import ExadataMetricDimensionDefinition
from .exadata_vm_cluster_summary import ExadataVmClusterSummary
...
from .storage_grid_discovery_summary import StorageGridDiscoverySummary
from .storage_server_discovery_summary import StorageServerDiscoverySummary
...
from .update_cloud_exadata_storage_connector_details import UpdateCloudExadataStorageConnectorDetails
from .update_cloud_exadata_storage_grid_details import UpdateCloudExadataStorageGridDetails
from .update_cloud_exadata_storage_server_details import UpdateCloudExadataStorageServerDetails
...
from .vm_cluster_discovery_summary import VMClusterDiscoverySummary
...
database_management_type_mapping = {
    ...
    "CloudExadataInfrastructureCollection": CloudExadataInfrastructureCollection,
    "CloudExadataInfrastructureDiscovery": CloudExadataInfrastructureDiscovery,
    "CloudExadataInfrastructureSummary": CloudExadataInfrastructureSummary,
    "CloudExadataStorageConnector": CloudExadataStorageConnector,
    "CloudExadataStorageConnectorCollection": CloudExadataStorageConnectorCollection,
    "CloudExadataStorageConnectorStatus": CloudExadataStorageConnectorStatus,
    "CloudExadataStorageConnectorSummary": CloudExadataStorageConnectorSummary,
    "CloudExadataStorageGrid": CloudExadataStorageGrid,
    "CloudExadataStorageGridSummary": CloudExadataStorageGridSummary,
    "CloudExadataStorageServer": CloudExadataStorageServer,
    "CloudExadataStorageServerCollection": CloudExadataStorageServerCollection,
    "CloudExadataStorageServerSummary": CloudExadataStorageServerSummary,
    "CloudIormPlan": CloudIormPlan,
    ...
    "CloudOpenAlertHistory": CloudOpenAlertHistory,
    ...
    "ExadataFleetMetricDefinition": ExadataFleetMetricDefinition,
    "ExadataFleetMetricSummaryDefinition": ExadataFleetMetricSummaryDefinition,
    "ExadataInfrastructureDiscoverySummary": ExadataInfrastructureDiscoverySummary,
    "ExadataInfrastructureFleetHealthMetrics": ExadataInfrastructureFleetHealthMetrics,
    "ExadataInfrastructureFleetStatusByCategory": ExadataInfrastructureFleetStatusByCategory,
    ...
    "ExadataInfrastructureUsageMetrics": ExadataInfrastructureUsageMetrics,
    "ExadataMetricDimensionDefinition": ExadataMetricDimensionDefinition,
    "ExadataVmClusterSummary": ExadataVmClusterSummary,
    ...
    "StorageGridDiscoverySummary": StorageGridDiscoverySummary,
    "StorageServerDiscoverySummary": StorageServerDiscoverySummary,
    ...
    "VMClusterDiscoverySummary": VMClusterDiscoverySummary,
