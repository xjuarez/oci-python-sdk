...
class CloudIormPlan(object):
    """
    The IORM plan from an Exadata storage server.
    """

    #: A constant which can be used with the plan_status property of a CloudIormPlan.
    ...
    #: A constant which can be used with the plan_objective property of a CloudIormPlan.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CloudIormPlan object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param plan_status:
            The value to assign to the plan_status property of this CloudIormPlan.
        ...
        :param plan_objective:
            The value to assign to the plan_objective property of this CloudIormPlan.
        ...
        :param db_plan:
            The value to assign to the db_plan property of this CloudIormPlan.
    ...
    def plan_status(self):
        """
        **[Required]** Gets the plan_status of this CloudIormPlan.
        ...
        :return: The plan_status of this CloudIormPlan.
        :rtype: str
        """
    ...
    def plan_status(self, plan_status):
        """
        Sets the plan_status of this CloudIormPlan.
        The status of the IORM plan.


        :param plan_status: The plan_status of this CloudIormPlan.
        :type: str
        """
    ...
    def plan_objective(self):
        """
        **[Required]** Gets the plan_objective of this CloudIormPlan.
        ...
        :return: The plan_objective of this CloudIormPlan.
        :rtype: str
        """
    ...
    def plan_objective(self, plan_objective):
        """
        Sets the plan_objective of this CloudIormPlan.
        The objective of the IORM plan.


        :param plan_objective: The plan_objective of this CloudIormPlan.
        :type: str
        """
    ...
    def db_plan(self):
        """
        Gets the db_plan of this CloudIormPlan.

        :return: The db_plan of this CloudIormPlan.
    ...
    def db_plan(self, db_plan):
        """
        Sets the db_plan of this CloudIormPlan.

        :param db_plan: The db_plan of this CloudIormPlan.
